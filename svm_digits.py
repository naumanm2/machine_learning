...
print(f"test score: {clf.score(test_data_x, test_data_y)}")
print("SVC training scores: ", train_scores, "mean: ", train_scores.mean())
print("SVC validation scores: ", val_scores, "mean: ", val_scores.mean())
